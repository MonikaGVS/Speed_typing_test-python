...
titleLabel=Label(titleframe,text='Typing Speed Testing',font=('algerian',28,'bold'),bg='goldenrod3',fg='white'
                 ,width=38,bd=10)
titleLabel.grid(pady=5)

paragraph_frame=Frame(mainframe)
paragraph_frame.grid(row=1,column=0)
paragraph_list=['Books are our best companions because they give us knowledge and peace of mind unconditionally.',
'Although we have friends and family to share our thoughts and get suggestions, we think books are the best when it comes to live a life full of wisdom, but no explanation.',
'A book can be the one thing which I can read all day long leaving behind all the problems. I like books because they give us knowledge, but never expect us, or force us to remain obedient to one proven or unproven piece of information.',
'These are not the only reasons that I think books are our best companies. Books also offer knowledge about different aspects of life. If you’ve to understand a concept in depth,',
'read books.This is why books are always the best option.']
